...
- **衝刺280**：考前 280 關鍵聯想（英文題幹關鍵詞 → 答案；條列／英文字卡；章節篩選）。資料：`data/cram280.json`、`考前衝刺_280關鍵知識點.md`。
...
| 檔案 | 用途 |
|---|---|
| `index.html` | 網站入口（名詞手冊 + 精讀講義 + 衝刺280 + 題庫練習一／二／三） |
...
| `data/cram280.json` | 考前衝刺 280 關鍵聯想（中英雙語） |
| `考前衝刺_280關鍵知識點.md` | 衝刺清單 Markdown 版 |
